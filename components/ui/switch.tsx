  ...
  return (
    ...
    >
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none relative z-10 block rounded-full bg-background ring-0 transition-transform duration-300 ease-out will-change-transform group-data-[size=default]/switch:size-4 group-data-[size=lg]/switch:size-7 group-data-[size=sm]/switch:size-3 group-data-[size=default]/switch:data-checked:translate-x-[calc(100%-2px)] group-data-[size=lg]/switch:data-checked:translate-x-8 group-data-[size=sm]/switch:data-checked:translate-x-[calc(100%-2px)] dark:data-checked:bg-primary-foreground group-data-[size=default]/switch:data-unchecked:translate-x-0 group-data-[size=lg]/switch:data-unchecked:translate-x-0 group-data-[size=sm]/switch:data-unchecked:translate-x-0 dark:data-unchecked:bg-foreground",
          thumbClassName
        )}
      >
        {thumbChildren}
